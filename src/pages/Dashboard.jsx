      ...
      <nav className={`border-b ${theme.nav} shadow-sm`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center">
              ...
              {/* Notifications */}
              <button className={`p-1 rounded-full ${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-500 hover:text-black'} mr-3`}>
              ...
              <div className="relative">
                ...
                >
                  <div className={`h-8 w-8 rounded-full flex items-center justify-center ${darkMode ? 'bg-indigo-600' : 'bg-indigo-100'}`}>
                ...
                {isMenuOpen && (
                  <div className={`absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 ${darkMode ? 'bg-gray-800 ring-1 ring-black ring-opacity-5' : 'bg-white ring-1 ring-black ring-opacity-5'}`}>
                    {renderProfileMenu()}
                  </div>
                )}
              </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            ...
            <div className={`pt-4 pb-3 border-t ${darkMode ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-gray-50'}`}>
              <div className="flex items-center px-5">
                <div className={`h-10 w-10 rounded-full flex items-center justify-center ${darkMode ? 'bg-indigo-600' : 'bg-indigo-100'}`}>
